...
const individualMuscleProgress: Record<string, {
  xp: number;
  goal: number;
  percentage: number;
  streak: number;
  ...
  'adductor_longus_and_pectineus': { xp: 200, goal: 300, percentage: 67, streak: 2, sets: 4 },
  ...
  'tensor_fasciae_latae': { xp: 140, goal: 300, percentage: 47, streak: 1, sets: 2 },
  ...
  'extensor_carpi_radialis': { xp: 280, goal: 300, percentage: 93, streak: 4, sets: 8 },
  'flexor_carpi_radialis': { xp: 260, goal: 300, percentage: 87, streak: 3, sets: 7 },
  'flexor_carpi_ulnaris': { xp: 240, goal: 300, percentage: 80, streak: 3, sets: 6 },
  ...
  'sternocleidomastoid': { xp: 180, goal: 300, percentage: 60, streak: 2, sets: 4 },
};
...
const Page = () => {
  ...
  const filteredMuscles = muscles.filter(muscle => muscle.majorGroup === majorGroup);
      ...
      >
        ...
        <View className="mx-4 mt-4 mb-6">
          <View className="bg-[#1c1c1e] rounded-2xl p-4">
            <Text className="text-white text-lg font-Poppins_600SemiBold mb-4 text-center">
        ...
        <View className="px-4">
          ...
          <View>
            {filteredMuscles.map((muscle, index) => {
              const muscleProgress = individualMuscleProgress[muscle.svgId] || {
                xp: 0, goal: 500, percentage: 0, streak: 0, sets: 0
              };
                          ...
                          <View className="flex-row items-center gap-3 mt-2">
                            <Badge variant="outline">
                              <Text className="text-white text-xs">
                                {getStreakEmoji(muscleProgress.streak)} {muscleProgress.streak} weeks
                              </Text>
                            </Badge>
